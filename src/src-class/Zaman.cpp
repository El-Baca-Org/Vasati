...
void zaman::vkt_h_v_d()
{
	...
	std::string h_rakam_gun_senenin_str = std::to_string(zaman::h_rakam_gun_senenin);
	zaman::xml_bu_gun        = zaman::sehir.find_child_by_attribute("prayertimes", "dayofyear", h_rakam_gun_senenin_str.c_str()).text().get();
	...
	std::string next_day_str = std::to_string(zaman::h_rakam_gun_senenin + 1);
	zaman::xml_bu_gun        = zaman::sehir.find_child_by_attribute("prayertimes", "dayofyear", next_day_str.c_str()).text().get();
